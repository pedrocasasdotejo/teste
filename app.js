...
function onZonaChange(){
  ...
  z.anomalias.forEach(a=>{const o=document.createElement('option');o.value=a.id;o.textContent=a.nome;sel.appendChild(o);});
  clearAnomaliaFields();
}
...
function确认Limpar(){document.getElementById('modal-limpar').classList.add('open');}
